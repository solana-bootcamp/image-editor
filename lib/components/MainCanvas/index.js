...
var MainCanvas = function () {
  var a = useResizeObserver(),
    b = _slicedToArray(a, 1),
    c = b[0],
    d = useStore(),
    e = useCallback(function (a) {
      ...
      d.dispatch({
        ...
        payload: { canvasWidth: b, canvasHeight: c },
      });
    }, []),
  ...
  return React.createElement(
    CanvasContainer,
    { className: "FIE_canvas-container", ref: f },
    !d.textIdOfEditableContent && React.createElement(NodeControls, null),
    d.isShowOriginalImage &&
      React.createElement(StyledOrignalImage, {
        className: "FIE_original-image-compare",
        src: d.originalImage.src,
      }),
    React.createElement(
      CanvasNode,
      null,
      React.createElement(
        ...
        { overridingValue: d },
        React.createElement(DesignLayer, null),
        React.createElement(TransformersLayer, null)
      )
    )
  );
};
