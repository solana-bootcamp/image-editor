...
var ZOOM_DELTA_TO_SCALE_CONVERT_FACTOR = 0.006,
  CanvasNode = function (a) {
    ...
    var t = DEFAULT_ZOOM_FACTOR,
      ...
      v = useState(
        h !== TABS_IDS.ANNOTATE && h !== TABS_IDS.WATERMARK && p.factor > t
      ),
      ...
      z = useMemo(
        function () {
          return {
            cursor:
              g === POINTER_ICONS.DEFAULT && h === TABS_IDS.ANNOTATE
                ? POINTER_ICONS.DRAW
                : g,
          };
        },
      ...
      A = function (a) {
        f({ type: ZOOM_CANVAS, payload: a });
      },
      B = useCallback(
        function (a) {
          var b, c;
          a.evt.preventDefault(),
            null === (b = (c = a.currentTarget).container) || void 0 === b
              ? void 0
              : b.call(c).focus(),
            a.target instanceof Konva.Stage &&
              0 < n.length &&
      ...
      D = function (a) {
        ("Space" === a.code || "Control" === a.key) &&
          ...
          f({
            ...
            payload: { pointerCssIcon: POINTER_ICONS.DRAG },
          }));
      },
      E = function (a) {
    ...
    useEffect(
      function () {
        f({
          type: CHANGE_POINTER_ICON,
          payload: { pointerCssIcon: POINTER_ICONS[x ? "DRAG" : "DEFAULT"] },
        });
      },
      [x]
    ),
      useEffect(
        function () {
          ...
          return (
            c.current &&
              ((a = c.current.container()),
              a.addEventListener("mouseenter", F),
              a.addEventListener("keydown", D),
              a.addEventListener("keyup", E)),
            function () {
              a &&
                (a.removeEventListener("mouseenter", F),
                a.removeEventListener("keydown", D),
                a.removeEventListener("keyup", E));
            }
          );
        },
        [h, p.factor, t]
      ...
      StyledCanvasNode,
      {
        ...
        onWheel: u
          ? function handleZoom(a) {
              ...
              var b =
                  (p.factor || t) +
                  a.evt.deltaY * -ZOOM_DELTA_TO_SCALE_CONVERT_FACTOR,
                c = a.currentTarget.getPointerPosition();
              A(_objectSpread(_objectSpread({}, c), {}, { factor: b }));
            }
          : void 0,
        onTap: B,
        onClick: B,
        ...
        onDragStart: function preventDraggingIfMultiTouches(a) {
          var b;
          1 <
            (null === (b = a.evt.touches) || void 0 === b
              ? void 0
              : b.length) && y(!1);
        },
        onTouchEnd: u
          ? function endTouchesZoomingEnablePanning() {
              endTouchesZooming(C);
            }
          : void 0,
        ...
        onDragEnd: function handleCanvasDragEnd(a) {
          a.currentTarget.draggable() &&
            "stage" === a.target.nodeType.toLowerCase() &&
            u &&
            x &&
            A({
              factor: p.factor,
