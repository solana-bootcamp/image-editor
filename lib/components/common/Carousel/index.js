...
var Carousel = function (a) {
  var b = a.children,
    ...
    u = function (a, b) {
      var c = a.findIndex(function (a) {
        return a.classList.contains("FIE_carousel-item");
      });
      -1 !== c &&
        (a[c].scrollIntoView({
          inline: b,
      ...
      if (f.current) {
        var b,
          c = ((null === (b = a.touches) || void 0 === b ? void 0 : b[0]) || a)
            .pageX;
        g.current.scrollBy(f.current - c, 0),
          (f.current = c),
          debounce(t, 30)();
      }
    },
    ...
    x = function (a) {
      var b;
      (f.current = (
        (null === (b = a.touches) || void 0 === b ? void 0 : b[0]) || a
      ).pageX),
        document.addEventListener("mousemove", v),
        document.addEventListener("mouseup", w),
        document.addEventListener("touchmove", v),
        document.addEventListener("touchcancel", w),
  ...
  return (
    ...
    React.createElement(
      ...
      m &&
        React.createElement(
          StyledPrevArrowWrapper,
          {
            ...
            onClick: function scrollToPrev(a) {
              var b = getScrollOffset(),
                c = b.topOffset,
                d = b.leftOffset,
                e = document.elementsFromPoint(
                  a.pageX + a.currentTarget.offsetWidth - d,
                  a.pageY - c
                );
              u(e, "end");
            },
      ...
      React.createElement(
        StyledCarousel,
        { className: "".concat(d, "-items"), ref: g },
        s.map(function (a) {
          return React.createElement(
            StyledCarouselItem,
            {
              className: "".concat(d, "-item-wrapper FIE_carousel-item"),
              key: a.key,
            },
            a
          );
      ...
      q &&
        React.createElement(
          StyledNextArrowWrapper,
          {
            ...
            onClick: function scrollToNext(a) {
              var b = getScrollOffset(),
                c = b.topOffset,
                d = b.leftOffset,
                e = document.elementsFromPoint(
...
Carousel.defaultProps = { style: null };
