...
var PositionFields = function (a) {
  var b = a.annotation,
    ...
    e = d.designLayer,
    f = function (a) {
      c(mapPositionStringToPoint(b, e, a));
    },
    g = AVAILABLE_POSITIONS.length;
  return AVAILABLE_POSITIONS.map(function (a, b) {
    return React.createElement(
      ...
      React.createElement(
        ...
        a === POSITIONS.MIDDLE_CENTER
          ? React.createElement(Point, null)
          : React.createElement(ArrowRightAlt, {
              style: {
                transform: "rotate(".concat(
                  posCssRotateDegFromRightSide[a],
                  "deg)"
                ),
              },
            })
      ),
      0 == (b + 1) % 3 && b + 1 !== g && React.createElement("div", null)
    );
  });
};
