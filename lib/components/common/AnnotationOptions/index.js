...
var AnnotationOptions = function (a) {
  var b = a.children,
    c = a.morePoppableOptionsPrepended,
    d = a.moreOptionsPopupComponentsObj,
    e = a.morePoppableOptionsAppended,
    f = a.annotation,
    g = a.updateAnnotation,
    h = a.hideFillOption,
    i = a.hidePositionField,
    j = a.className,
    k = _objectWithoutProperties(a, _excluded),
    l = useState(null),
    ...
    x = useMemo(
      function () {
        ...
        return _objectSpread(
          ...
          {},
          ((a = {}),
          _defineProperty(a, POPPABLE_OPTIONS.OPACITY, OpacityField),
          _defineProperty(a, POPPABLE_OPTIONS.STROKE, StrokeFields),
          _defineProperty(a, POPPABLE_OPTIONS.SHADOW, ShadowFields),
          _defineProperty(a, POPPABLE_OPTIONS.POSITION, PositionFields),
          a),
          e
        );
      },
    ...
    y = useCallback(function (a, b) {
      var c = null === a || void 0 === a ? void 0 : a.currentTarget;
      o(c), s(b);
    }, []),
    z = useCallback(
      function (a) {
  ...
  return React.createElement(
    StyledOptions,
    { className: "FIE_annotations-options".concat(j ? " ".concat(j) : "") },
    !h && React.createElement(ColorInput, { color: f.fill, onChange: z }),
    b,
    t.map(function (a) {
      return (
        a &&
    ...
    A &&
      React.createElement(
        ...
        React.createElement(
          ...
          React.createElement(
            A,
            _extends({ annotation: f, updateAnnotation: g }, k)
          )
        )
      )
  );
