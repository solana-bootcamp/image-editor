      ...
      o = useMemo(
        function () {
          ...
          return [].concat(
            ...
            _toConsumableArray(DEFAULT_CROP_PRESETS),
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        o.map(function renderPreset(a) {
          ...
          return h
            ? React.createElement(CropPresetGroupsList, {
                key: b,
                titleKey: b,
                groups: h,
                Icon: j,
            ...
            : React.createElement(CropPresetItem, {
                ...
                isActive:
                  i ===
                    (null !== d && void 0 !== d ? d : toPrecisedFloat(e / f)) &&
                  !k,
                width: e,
                height: f,
                onClick: p,
...
CropPresetsOption.defaultProps = { anchorEl: null };
