...
export var DEFAULT_CROP_PRESETS = [
  { titleKey: "original", ratio: ORIGINAL_CROP, icon: ImageOutline },
  { titleKey: "custom", ratio: CUSTOM_CROP, icon: Custom },
  {
    titleKey: "landscape",
    descriptionKey: "16:9",
  ...
  { titleKey: "ellipse", ratio: ELLIPSE_CROP, icon: Ellipse },
];
