...
var DEFAULT_VALUE = { hue: 0, saturation: 0, value: 0 },
  sliderStyle = { padding: 0 },
  HSVOptions = function (a) {
    var b,
      c,
      d,
      e = a.t,
      f = useFinetune(Konva.Filters.HSV, DEFAULT_VALUE),
      g = _slicedToArray(f, 2),
      h = g[0],
      i = g[1],
      j = function (a, b) {
        i(_defineProperty({}, a, +b));
      };
    return React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(Slider, {
          ...
          step: 1,
          max: 259,
          value: null !== (b = h.hue) && void 0 !== b ? b : DEFAULT_VALUE.hue,
      ...
      React.createElement(
        ...
        React.createElement(Slider, {
          ...
          max: 10,
          value:
            null !== (c = h.saturation) && void 0 !== c
              ? c
              : DEFAULT_VALUE.saturation,
          onChange: function onChange(a) {
            return j("saturation", a);
          },
          style: sliderStyle,
        })
      ),
      React.createElement(
        ...
        React.createElement(Slider, {
          ...
          max: 2,
          value:
            null !== (d = h.value) && void 0 !== d ? d : DEFAULT_VALUE.value,
          onChange: function onChange(a) {
            return j("value", a);
          },
          style: sliderStyle,
