...
var ADDED_IMG_SPACING_PERCENT = 0.15,
  ImageOptions = function () {
    var a = useState(),
      ...
      j = void 0 === i ? {} : i,
      k = f.t,
      l = useAnnotation({ name: TOOLS_IDS.IMAGE, opacity: 1 }, !1),
      ...
      r = function (a) {
        var b = j.width || g.width,
          ...
          f = Math.min(
            1,
            b / (a.width + a.width * ADDED_IMG_SPACING_PERCENT),
            c / (a.height + a.height * ADDED_IMG_SPACING_PERCENT)
          );
        p({
          image: a,
          x: d + b / 2 - (a.width * f) / 2,
    ...
    return React.createElement(
      ...
      React.createElement(
        ...
        c ? k("importing") : k("addImage")
      ),
      React.createElement(HiddenUploadInput, {
        ref: e,
        onChange: c
          ? void 0
          : function importImages(a) {
              if (a.target.files) {
                d(!0);
                var b = [],
