...
var ToolsBar = function () {
  var a,
    ...
    n = e || k,
    o =
      f || l || (null === (a = TABS_TOOLS[n]) || void 0 === a ? void 0 : a[0]),
    p = useMemo(
      function () {
        return TABS_TOOLS[n] || [];
      },
    ...
    q = useCallback(function (a) {
      d({ type: SELECT_TOOL, payload: { toolId: a } });
    }, []),
    r = useMemo(
      function () {
    ...
    s = useMemo(
      function () {
        var a, b, c;
        if (!o) return !1;
        if (n === TABS_IDS.ANNOTATE) {
          var h = i.length;
          if (1 === h) {
            var d,
              e = g[i[0]];
            return null === (d = TOOLS_ITEMS[e.name]) || void 0 === d
              ? void 0
              : d.ItemOptions;
          }
          if (1 < h) return null;
        ...
        return (
          n &&
          o &&
          TABS_TOOLS[n].includes(o) &&
          (!(null !== (a = TOOLS_ITEMS[f]) && void 0 !== a && a.hideFn) ||
            !(
              null !== (b = TOOLS_ITEMS[f]) &&
              void 0 !== b &&
              b.hideFn({ useCloudimage: m })
            )) &&
          (null === (c = TOOLS_ITEMS[f]) || void 0 === c
            ? void 0
            : c.ItemOptions)
        );
      },
  ...
  return (
    useEffect(function () {
      !f && o && d({ type: SELECT_TOOL, payload: { toolId: o } });
    }, []),
    React.createElement(
      StyledToolsBar,
