...
var isFieMounted = !0,
  AppProvider = function (a) {
    var b = a.children,
      c = a.config,
      d = void 0 === c ? {} : c,
      e = useAppReducer(appReducer, getInitialAppState(d), d),
      ...
      k = useMemo(
        function () {
          return _objectSpread(
            _objectSpread({}, g),
            {},
            { config: d, theme: j, dispatch: i, t: translate }
          );
        },
        [d, g]
      );
    return React.createElement(AppContext.Provider, { value: k }, b);
  };
AppProvider.defaultProps = { config: {} };
